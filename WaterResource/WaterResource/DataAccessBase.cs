...
namespace WaterResource
{
    ...
    public class DataAccessBase
    {
        ...
        {
          // this.Cs = "Data Source=.;Initial Catalog=WaterResource;user id=sa;password=P@ssw0rd";
       
            this.Cs = "Data Source=172.16.33.252;Initial Catalog=WSNew1;user id=sa;password=P@ssw0rd";
            this.Cn = null;
            this.Cmd = null;
        }
